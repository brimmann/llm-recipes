...
# class XGemmaConfig(Gemma3Config):
#     model_type = "gemma3"
#     def __init__(
#         self,
...
class Projector(nn.Module):
    def __init__(self):
        ...
        mlp_gelu_match = "mlp2x_gelu"
        if mlp_gelu_match:
            mlp_depth = 2
            modules = [nn.Linear(4096, 1152)]
            for _ in range(1, mlp_depth):
                modules.append(nn.GELU())
                modules.append(nn.Linear(1152, 1152))
...
class XGemmaForCausalLM(Gemma3ForCausalLM):
    def __init__(self,config):
        ...
        self.retriever_hidden_size = 4096
        self.post_init()
