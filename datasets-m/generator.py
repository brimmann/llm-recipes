...
if __name__ == "__main__":
    ...
    else: dataset = load_dataset(args.dataset_id, split=args.split_name).select(range(5))
    ...
    dataset_generated.save_to_disk(f"/content/drive/MyDrive/mistral-sqaud-ds/{args.split_name}")
